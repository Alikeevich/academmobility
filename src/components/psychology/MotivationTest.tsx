...
export default function MotivationTest({ language }: { language: Language }) {
  ...
  const calculateResult = () => {
    ...
    const messages = {
      ...
      worst: {
        ru: "Негативный комплекс. Преобладает страх и желание избежать проблем.",
        kk: "Жағымсыз кешен. Қорқыныш пен проблемалардан қашу басым.",
        en: "Negative complex. Fear and desire to avoid trouble prevail."
      },
      middle: {
        ru: "Промежуточный комплекс. Внешние и внутренние мотивы смешаны.",
        kk: "Аралық кешен. Сыртқы және ішкі мотивтер аралас.",
        en: "Intermediate complex. External and internal motives are mixed."
      }
    };
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200">
      ...
      <p className="text-xs text-gray-400 mb-4 italic">{MOTIVATION_TEST.instruction[language]}</p>
